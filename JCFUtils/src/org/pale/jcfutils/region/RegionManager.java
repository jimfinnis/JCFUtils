...
public class RegionManager {
    ...
    Map<Integer,Region> regMap = new TreeMap<Integer,Region>();
    ...
    // get all regions sorted by number
    ...
    public void loadConfig() {
        ...
        if(sec!=null) {
            ...
            Map<Integer,Region> newm = new TreeMap<Integer,Region>(); 
    ...
    public void saveConfig() {
        ...
        // we want to save a map of strings, because that's how it works.
        Map<String,Region> m = new TreeMap<String,Region>();
